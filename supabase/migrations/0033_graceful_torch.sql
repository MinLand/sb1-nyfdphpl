...
BEGIN
  ...
  DROP FUNCTION IF EXISTS record_player_action(p_action_type text, p_company_id text, p_cost numeric, p_doctor_name text, p_room_id text, p_round_number integer, p_topic text);
EXCEPTION 
